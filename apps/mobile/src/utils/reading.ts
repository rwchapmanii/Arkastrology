...
export function sanitizeReadingResponse(result: AnyReadingResponse): AnyReadingResponse {
  ...
  return {
    ...
    reading: {
      ...
      emotional_weather: cleanString(result.reading.emotional_weather),
      practical_focus: cleanString(result.reading.practical_focus),
      primary_action: cleanString(result.reading.primary_action),
      supporting_actions: cleanStringArray(result.reading.supporting_actions),
      avoid_pattern: cleanString(result.reading.avoid_pattern),
      reflection_prompt: cleanString(result.reading.reflection_prompt),
      check_in_question: cleanString(result.reading.check_in_question),
      weather_context: cleanString(result.reading.weather_context),
      season_context: cleanString(result.reading.season_context),
      climate_context: cleanString(result.reading.climate_context),
