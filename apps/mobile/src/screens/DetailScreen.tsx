...
function realLifeExample(block: InterpretationBlock) {
  const examples: Record<string, string> = {
    ...
    levi_current: 'This may look like a symbolic or imaginal theme that keeps describing the bond well, without replacing the chart structure underneath it.',
